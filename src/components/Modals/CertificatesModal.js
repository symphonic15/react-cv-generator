  ...
  const CertificateItem = ({index}) => {
    return (
      <div className="form-edit-group" key={index}>
        ...
        <div className="form-edit-item">
          <button className="remove-btn" onClick={(e) => removeCertificatesItem(e, index)}>Eliminar</button>
        </div>
      </div>
    );
  }
    ...
    >
      ...
      <div className="modal-body">
        <form className="form-edit">
          ...
          <button className="add-btn" onClick={(e) => addCertificateItem(e)}>Agregar estudio</button>
        </form>
      </div>
